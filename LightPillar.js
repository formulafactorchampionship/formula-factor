...
export function initLightPillar(containerId, options = {}) {
  ...
  const defaultProps = {
    topColor: '#d6b45c',    // Champion Gold
    bottomColor: '#3b82f6', // Electric Blue (matching the new globe markers!)
    intensity: 1.0,
    rotationSpeed: 0.25,
    interactive: true,
    glowAmount: 0.012,
  ...
  root.render(
    React.createElement(LightPillar, finalProps)
  );
}
