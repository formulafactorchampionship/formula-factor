...
import { Renderer, Program, Triangle, Mesh } from 'https://esm.sh/ogl@0.0.104';
...
export function initSideRaysBackground(containerId, options = {}) {
  ...
  // Default FFC luxury gold & speed green settings
  const defaultProps = {
    speed: 1.8,
    rayColor1: '#d6b45c', // Champion Gold accent
    rayColor2: '#10b981', // Turbo Green accent
    intensity: 1.8,
    spread: 2.2,
    origin: 'top-right',
    tilt: -5,
  ...
  const finalProps = { ...defaultProps, ...options };

  root.render(
    React.createElement(SideRays, finalProps)
  );
}
